...
async function generateFlipAnimation(widthCSS, heightCSS, dpr, DD, HH, MM, padX, padY, groupGap, panelGap, panelW, panelH, panelR, labelY, labelPx) {
  ...
  for (let frame = 0; frame < frameCount; frame++) {
    ...
    drawGroupWithFlip(DD, 'DAYS', daysFlip > 0, daysFlip);
    drawGroupWithFlip(HH, 'HOURS', hoursFlip > 0, hoursFlip);
    drawGroupWithFlip(MM, 'MINUTES', minutesFlip > 0, minutesFlip);
